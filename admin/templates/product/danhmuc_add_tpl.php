        ...
        <div id="info" class="tab_content">
            ...
            <div class="formRow">
                ...
                <div class="formRight">
                    ...
                    <div class="note"> Height:330px | Width:375px  <?=_format_duoihinh_l?> </div>
                </div>
                <div class="clear"></div>
            </div>
            ...
            <div class="formRow">
                <label>Chạy slide : <img src="./images/question-button.png" alt="Chọn loại" class="icon_que tipS" original-title="Bỏ chọn để không hiển thị danh mục này ! "> </label>

                <div class="formRight">
                    <input type="checkbox" name="slider" id="check1" <?=(!isset($item['slider']) || $item['slider']==1)?'checked="checked"':''?> />
                </div>
                <div class="clear"></div>
            </div>
