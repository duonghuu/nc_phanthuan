       ...
       <div id="info" class="tab_content">
        ...
        <div class="formRow">
         ...
         <div class="formRow">
            <label>Giá cũ: </label>
            <div class="formRight">
                <input type="text" id="price" name="giacu" value="<?=@$item['giacu']?>"  title="Nhập giá sản phẩm" class="tipS" onkeypress="return OnlyNumber(event)" />
            </div>
            <div class="clear"></div>
        </div>
        ...
        <div class="formRow">
			...
			<div class="formRight">
				...
				<div class="note">Width:500px | Height:400px<?=_format_duoihinh_l?> </div>
			</div>
			<div class="clear"></div>
		</div>
