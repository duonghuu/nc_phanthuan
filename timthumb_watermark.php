...
// & wm  => 0 là Off , 1 Là On
// &wl => Vị trí wartermark là 1,2,3,4,5,6,7,8,9 tương ứng với 1 Trên trái, 2 trên giữa, 3 trên phải, 4 giữa phải, 5 dưới phải, 6 giữa dưới, 7 phải dưới, 8 giữa trái , còn lại chính giữa
// &wmr => khoản cách viền (tương đương margin)
...
//if(!defined('WATERMARK_OVERLAY_IMAGE')) define('WATERMARK_OVERLAY_IMAGE',dirname(FILE).$_SESSION['dong']);
...
class timthumb {
	...
	protected function processImageAndWriteToCache($localImage){
		...
		if ($watermark == 1) {
			//WATERMARK_OVERLAY_IMAGE = 'upload/hinhanh/dongdau-7677.png';

			// Kiểm tra kích thước hình đóng dấu
			if($_GET['w'] < 400){
				$overlay_gd_image = imagecreatefrompng($_SESSION['dong']);
			} else {
				$overlay_gd_image = imagecreatefrompng($_SESSION['dong']);
			}
