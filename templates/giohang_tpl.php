...
<div class="box_container"> 
	<div class="title"><div><?=_giohang?></div></div>
	<div class="content">
    	<div class="left_gh">
  ...
  <div class="right_gh">
    ...
    <form method="post" name="frm_order" id="frm_order" action="" enctype="multipart/form-data" onsubmit="return check();">
        ...
        <div class="item_lienhe form-group"><input class="form-control" placeholder="Họ và tên" name="hoten" type="text" id="hoten" value="<?php if($_POST['hoten']!='')echo $_POST['hoten'];else echo $info_user['ten']?>"/></div>
        ...
        <div class="item_lienhe form-group"><input class="form-control" placeholder="Điện thoại" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" name="dienthoai" id="dienthoai" value="<?php if($_POST['dienthoai']!='')echo $_POST['dienthoai'];else echo $info_user['dienthoai']?>" type="text"  /></div>
        ...
        <div class="item_lienhe form-group"><input class="form-control" placeholder="Địa chỉ" name="diachi" type="text" id="diachi" value="<?php if($_POST['diachi']!='')echo $_POST['diachi'];else echo $info_user['diachi']?>" /></div>

        <div class="item_lienhe form-group"><input class="form-control" placeholder="Email" name="email" type="text" id="email" value="<?php if($_POST['email']!='')echo $_POST['email'];else echo $info_user['email']?>" /></div>
        
        <div class="item_lienhe form-group"><textarea class="form-control" name="noidung" placeholder="Nội dung" cols="50" rows="1" ><?=$_POST['noidung']?></textarea></div>
      </form>
      </div>
